...
export const FUNCTIONS = {
  'auto-responder': {
    title: 'Auto-responder', cadence: 'daily', status: 'wiring',
  ...
  'knowledgebase': {
    title: 'Knowledgebase', cadence: 'daily', status: 'planned',
  ...
  'summit-scan-checks': {
    title: 'Summit Scan Checks', cadence: 'daily', status: 'planned',
  ...
  'upload-statements': {
    title: 'Summit Upload Statements', cadence: 'monthly', status: 'wiring',
